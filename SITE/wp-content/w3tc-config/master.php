<?php exit; ?>{
    ...
    "cdn.includes.files": "*.css;*.js;*.gif;*.png;*.jpg;*.ico;*.ttf;*.otf;*.woff;*.less;*.woff2;*.eot;*.svg;*.xml;*.json;*.gzip;*.jpeg;*.bmp;",
    "cdn.theme.enable": "1",
    "cdn.theme.files": "*.css;*.js;*.gif;*.png;*.jpg;*.ico;*.ttf;*.otf;*.woff;*.less;*.woff2;*.eot;*.svg;*.xml;*.json;*.gzip;*.jpeg;*.bmp;",
    ...
    "cdn.custom.files": [
        ...
        "{uploads_dir}\/*.json",
        "{uploads_dir}\/*.xml",
        "{uploads_dir}\/bfi_thumb\/*.jpg",
        "{uploads_dir}\/bfi_thumb\/*.jpeg",
        "{uploads_dir}\/bfi_thumb\/*.png",
        "{uploads_dir}\/bfi_thumb\/*.bmp",
        "{uploads_dir}\/bfi_thumb\/*.gif",
